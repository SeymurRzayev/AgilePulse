...
function Lines() {
  return (
    <>
      ...
      <img
        className="absolute hidden   lg:block h-[3.6%] top-[4%] right-[50%] "
        src={arrshortteam}
        alt="line"
      />
      {/* inner up line */}
      ...
      {/* inner left line */}
      <img
        className="absolute  hidden   lg:block h-[19.68%]  top-[5.5%] left-[34.8%] "
        src={shortsideline}
        alt="line"
      />
      {/* inner right line */}
      <img
        className="absolute  hidden   lg:block h-[42%]  top-[5.5%] right-[35.4%] "
        src={longsideline}
        alt="line"
      />
      {/* inner bottom line */}
      <img
        className="absolute  hidden   lg:block w-[15%] top-[24.9%] left-[34.8%] "
        src={shortlineteam}
        alt="line"
      />
      {/* inner downward arrow */}
      <img
        className="absolute hidden   lg:block h-[5%] top-[24.9%] left-[48.7%] "
        src={arrowline152}
        alt="line"
      />
      {/* second bottom line */}
      ...
      {/* down left line */}
      <img
        className="absolute  hidden   lg:block w-[30.2%]   top-[58%] left-[20%] "
        src={lineteamsvg}
        alt="line"
      />
      {/* down right line */}
      ...
      <img
        className="absolute  hidden   lg:block   top-[58%] right-[19.5%] "
        src={arrowline152}
        alt="line"
      />
      {/* down left downward line */}
      <img
        className="absolute  hidden   lg:block   top-[58%] left-[19.9%] "
        src={arrowline152}
        alt="line"
      />
    </>
