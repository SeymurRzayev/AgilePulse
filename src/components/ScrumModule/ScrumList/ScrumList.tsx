  ...
  return (
    <>
      <div className="w-[80%] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-[40px] sm:gap-[50px] lg:gap-[60px] font-corbel">
          <div className="flex flex-col gap-y-[5px]">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-4">Modul 1. Scrum-a giriş</h2>
            ...
            <AccordionItem content="Scrum və digər Agile metodologiyalar (Kanban, XP ilə müqayisə)" />
            <AccordionItem content="Scrum-un əsas dəyərləri və prinsipləri" />
          </div>
          <div className="flex flex-col">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-4">Modul 2. Scrum Rolları</h2>
          ...
          <div className="flex flex-col">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-4">Modul 3. Scrum Artifacts (Əsas sənədlər)</h2>
          ...
          <div className="flex flex-col">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-4">Modul 4. Scrum Hadisələri (Events)</h2>
          ...
          className="self-center !font-medium !font-[Montserrat] bg-gradient-to-r from-[#4A00E0] to-[#8E2DE2] w-full sm:w-auto px-6 py-3 text-sm sm:text-base" />

        </div>
      </div>

      <div className="w-[95%] sm:w-[90%] lg:w-[95%] mx-auto mt-16 sm:mt-20 lg:mt-25 px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-xl sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8">İstifadəçilər bu təlimləri də keçdilər</h2>
        <div className="w-full gap-8 mx-auto pt-2 items-center flex-col md:flex-row">
          <Slider {...settings}>
            {
              dummyMock.map((item, index) => (
