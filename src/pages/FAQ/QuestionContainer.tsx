    ...
    <div
      ...
      style={{
        boxShadow: "-1px 10px 26px -8px rgba(0,0,0,0.2)",
         background: 'linear-gradient(90deg, rgba(40, 68, 141, 1) 2.7%, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 100%)',
      }}
    >
      {/* Ağ div: sağ radius var, sol radius yoxdur */}
      <div
        className="w-[97.5%] bg-white rounded-r-[15px]  h-full py-3.5 md:py-6 pl-6 ml-1 pr-[60px]"
        style={{
          boxShadow: "4px 4px 12px 5px rgba(0, 0, 0, 0.09)",
        }}
      >
        <p className="font-bold  sm:text-[12px] md:text-xl lg:text-2xl leading-6 sm:leading-7 md:leading-8 text-[#2C4B9B] font-corbel">
          {question}
        </p>
      </div>
