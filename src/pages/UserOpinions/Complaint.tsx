          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-b from-gray-100 via-gray-200 to-gray-300 rounded-lg shadow-2xl p-6 sm:p-8 transition-transform duration-300 relative border border-gray-300">
              <div className="absolute -right-10 top-1/6 hidden md:flex flex-col gap-4">
                ...
                >
                  <span className="transform -rotate-90 whitespace-nowrap text-xs font-medium  font-[corbel] tracking-wider">
                    Təkliflər
                  </span>
                </button>
                <button
              ...
              <div className="space-y-4 sm:space-y-6 flex flex-col gap-3 justify-center ">
                ...
                <button
                  ...
                  className="w-full py-3 sm:py-4  text-white font-bold text-base sm:text-lg rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#681DB0] shadow-xl border border-[#681DB0] relative overflow-hidden transition-transform duration-300 "
                  style={{
                    background:
                      "linear-gradient(78deg, #000C67, #1a2893, #5468F8, #681DB0, #4f1ba1)",
