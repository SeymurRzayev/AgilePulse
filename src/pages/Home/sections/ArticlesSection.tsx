    ...
    const data = [
        {
            ...
            content: "Son dövrlərdə tez-tez eşitdiyimiz “agile”, “agile management” və ya “agile project management” layihə idarəetməsinin bir metodologiyası olaraq tanınır."
        },
        {
            id: 2,
            img: Article2,
    ...
    return (
        <div className='my-15'>
            <div className="mt-10 flex flex-col items-center gap-3">
                ...
                <p className="text-sm w-2/3 font-normal text-center">Agile metodologiyası haqqında ən son məqalələr, praktik yanaşmalar və mütəxəssis fikirləri ilə tanış olun.</p>
            </div>
            <div className="flex flex-wrap mt-15 justify-center gap-5">
                {
                    data.map(item => (
                        <div key={item.id} className='w-[30%]'>
                            <TrainingCard isArticle={true} title={item.title} imgUrl={item.img} content={item.content} />
                        </div>
                    ))
                }
            </div>
